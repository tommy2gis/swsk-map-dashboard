...
#  改成 AUTH_TYPE = AUTH_REMOTE_USER 后要重写方法   hz 2019/11/13
try:
    # you'd better put all the import stuff here, since superset will ignore it
    from superset.securityGeo.security_models import  MySecurityManager
    app.config["CUSTOM_SECURITY_MANAGER"] = MySecurityManager
