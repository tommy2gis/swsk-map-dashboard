...
const preview=getUrlParam('preview');
...
class DashboardBuilder extends React.Component {
  ...
  //   new ruler({
  //     container: document.querySelector('#app'),// reference to DOM element to apply rulers on
        ...
        <Sticky>
          {({ style }) => (
            <DragDroppable
              ...
              style={{ zIndex: 100,display:preview?'none':'block', ...style}}
            >
              {({ dropIndicatorProps }) => (
                <div>
                  <DashboardHeader />
