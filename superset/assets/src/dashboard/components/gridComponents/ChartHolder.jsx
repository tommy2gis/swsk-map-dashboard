...
import BackImageStyleDropdown from '../menu/BackImageStyleDropdown';
...
class ChartHolder extends React.Component {
  ...
  constructor(props) {
    ...
    this.handleChangeBkImage=this.handleChangeBkImage.bind(this);
    this.handleHideHeader = this.handleUpdateMeta.bind(
      this,
      'hideHeader',
    );
  }
  ...
  handleUpdateMeta(metaKey, nextValue) {
    ...
    if (component.meta[metaKey] !== nextValue) {
      updateComponents({
        [component.id]: {
          ...component,
          meta: {
      ...
      >
        {({ dropIndicatorProps, dragSourceRef }) => (
          <ResizableContainer
            ...
            editMode={editMode}
          >
            <div className={`dashboard-component-border ${component.meta.backgroundstyle}`}>
            <div
              ref={dragSourceRef}
              className={`dashboard-component dashboard-component-chart-holder ${
                this.state.outlinedComponentId ? 'fade-in' : 'fade-out'
              } ${
                component.meta.hideHeader ? 'hideheader' : ''
              }` }
            >
              {!editMode && (
                <AnchorLink
              ...
              {editMode && (
                <HoverMenu position="top">
                  ...
                  <Checkbox   checked={component.meta.hideHeader}
                  onChange={this.handleHideHeader}/>
                  <span className="m-l-5">{t('Hide Header')}</span>
                </div>
                  <BackImageStyleDropdown
                    id={`${component.id}-BIDropdown`}
                    value={component.meta.backgroundstyle||'border1'}
                    onChange={this.handleChangeBkImage}
                  />
