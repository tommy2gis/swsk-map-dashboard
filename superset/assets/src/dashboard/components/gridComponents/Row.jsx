...
import SelectPositionDropdown from '../menu/SelectPositionDropdown';
...
class Row extends React.PureComponent {
  constructor(props) {
    ...
    this.handleChangeOverlay = this.handleUpdateMeta.bind(
      this,
      'position',
    );
  ...
  // handleChangeOverlay(next){
  //   this.setState(() => ({ isOverlay: Boolean(next) }));
  // }
  ...
  render() {
    ...
    return (
      <DragDroppable
        ...
        index={index}
        depth={depth}
        className={rowComponent.meta.position&&`dragdroppable-row-position-${rowComponent.meta.position}`}
        ...
        {({ dropIndicatorProps, dragSourceRef }) => (
          <WithPopoverMenu
            ...
            menuItems={[
              ...
              id={`${rowComponent.id}-position`}
              value={rowComponent.meta.position||'bottom'}
              onChange={this.handleChangeOverlay}
            />
            ]}
            editMode={editMode}
          >
