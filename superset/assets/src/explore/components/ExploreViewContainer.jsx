  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="row">
          <div className="col-sm-4" style={{backgroundColor:'#fff'}}>
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center',padding:'10px 15px 5px 0px'}}>
              <QueryAndSaveBtns
                canAdd="True"
