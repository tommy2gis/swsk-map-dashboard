...
const D3_FORMAT_OPTIONS = [
  ...
  ['DURATION', '持续时间（毫秒） (66000 => 1m 6s)'],
  ['DURATION_SUB', '持续时间（毫秒） (100.40008 => 100ms 400µs 80ns)'],
];
...
export const controls = {
  ...
  mapbox_style: {
    ...
    renderTrigger: true,
    choices: [
      ['http://192.168.1.200:8089/static/assets/mapbox/MAP_STYLE_WX_DARKBLUE.json', '无锡深蓝'],
